...
export function CustomBackendsModal(props: { onClose: () => void }) {
  ...
  return (
    <Modal
      title={t('customBackends.title')}
      onClose={close}
      class="modal settings-modal"
      ariaLabel={t('customBackends.title')}
    >
      ...
      <section class="settings-section">
        <Show when={state.customBackends.length > 0} fallback={<p class="hint-text">{t('customBackends.empty')}</p>}>
