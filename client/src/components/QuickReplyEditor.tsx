...
export function QuickReplyEditor(props: Props) {
  ...
  return (
    <Portal mount={document.body}>
      <Modal
        title={props.qr ? t('quickReply.editQuickReply') : t('quickReply.newQuickReply')}
        onClose={close}
        class="modal-content qr-modal"
        titleAs="h3"
        ariaLabel={props.qr ? t('quickReply.editQuickReply') : t('quickReply.newQuickReply')}
      >
        <div class="form-row">
          <label class="field-label" for="qr-label">
            {t('quickReply.label')}
          </label>
          <input
            id="qr-label"
        ...
        <div class="form-row">
          <label class="field-label" for="qr-icon">
            {t('quickReply.iconEmoji')}
          </label>
          <input
            id="qr-icon"
            class="input"
        ...
        <div class="form-row">
          <label class="field-label" for="qr-color">
            {t('quickReply.color')}
          </label>
          <input
            id="qr-color"
        ...
        <Show when={!props.qr}>
          <div class="form-row">
            <label class="field-label" for="qr-scope">
              {t('quickReply.scope')}
            </label>
            <select
              id="qr-scope"
            ...
            >
              <option class="select-option" value="global">
                {t('quickReply.scopeGlobal')}
              </option>
              <Show when={props.characterId}>
                <option class="select-option" value="character">
                  {t('quickReply.scopeCharacter')}
                </option>
              </Show>
              <Show when={props.chatId}>
                <option class="select-option" value="chat">
                  {t('quickReply.scopeChat')}
                </option>
              </Show>
            </select>
          </div>
        ...
        <div class="form-row">
          <label class="field-label" for="qr-script">
            {t('quickReply.scriptLua')}
          </label>
          <textarea
            id="qr-script"
            value={script()}
        ...
        <div class="form-row">
          <label class="field-label" for="qr-order">
            {t('quickReply.order')}
          </label>
          <input
            id="qr-order"
