...
If you run a coding agent on your tamari data directory, it can edit unpacked card files directly. To let it _test_ cards, enable the built-in **MCP server**:
