...
test.describe('WI V3 Decorators', () => {
  ...
  test('@@activate fires entry without keyword match', async ({ page, app }) => {
  ...
  test('@@dont_activate suppresses entry even with keyword match', async ({ page, app }) => {
  ...
  test('@@depth injects at depth and @@role sets system role', async ({ page, app }) => {
  ...
  test('unknown @@ decorator does not leak into prompt', async ({ page, app }) => {
...
test.describe('WI V3 Decorators — activation semantics', () => {
  ...
  test('@@additional_keys: additional and primary keys both trigger', async ({ page, app }) => {
  ...
  test('@@exclude_keys: excluded key no longer triggers, other keys still do', async ({ page, app }) => {
  ...
  test('@@keep_activate_after_match: stays injected on later turns without the key', async ({ page, app }) => {
  ...
  test('@@dont_activate_after_match: fires once, never again', async ({ page, app }) => {
  ...
  test('@@activate_only_every 3: present, absent, present cadence', async ({ page, app }) => {
  ...
  test('@@activate_only_after 4: suppressed until the chat is long enough', async ({ page, app }) => {
  ...
  test('probability 0: key match never activates', async ({ page, app }) => {
  ...
  test('regex keys: pattern matches, invalid pattern is skipped without crashing', async ({ page, app }) => {
  ...
  test('@@@ fallback: unknown decorator falls back to @@@depth 2', async ({ page, app }) => {
  ...
  test('editor activation-test box lists matching entries', async ({ page, app: _app }) => {
