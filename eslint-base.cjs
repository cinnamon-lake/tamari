/**
 * Shared ESLint baseline for all @tamari/* workspaces.
 *
 * Each workspace's .eslintrc.cjs extends this and adds only what's specific to
 * it: parserOptions.{project,tsconfigRootDir,ecmaFeatures}, env (node/browser),
 * a handful of workspace-specific rules, and its test/import-legacy overrides.
 *
