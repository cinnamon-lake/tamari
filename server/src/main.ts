...
import { registerNaiImageTemplate } from './services/templates/NaiImageTemplate.js';
...
registerNaiImageTemplate(toolRegistry, { storage, attachments, secretService, secretsPassword: config.secret });
