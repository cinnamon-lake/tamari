...
- Prompt rules run as the **first** prompt-assembly splice stage, before Author's Note / World Info / injections, and before macro resolution in the renderer — a rule can inject macros, but macro output is not re-regexed.
